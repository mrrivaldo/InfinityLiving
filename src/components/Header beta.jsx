...
const Header = () => {
  ...
  const menuItems = [
    { 
        title: "About", 
        submenus: [
            "Our purpose", "Our values", "Our culture", "Strategy", 
            "Leadership", "Research & Development", "Health & Safety", 
            "Global reach", "Making steel", "FAQ"
        ] 
    },
    { 
        title: "Climate Action", 
        submenus: [
            "Steel's sustainability credentials", "Leading our industry’s efforts to decarbonise", 
            "Technology pathways to net-zero steel", "Decarbonisation technologies", 
            "Leadership", "Research & Development", "Health & Safety", 
            "Global reach", "Making steel", "FAQ"
        ] 
    },
  ...
  { 
      ...
      submenus: [
          "Our 10 SD Outcomes", "Approach", "ResponsibleSteel", 
          "UN Sustainable Development Goals", "Governance", "Human Rights"
      ] 
  },
  { 
      title: "Projects", 
      submenus: [] // Tidak ada submenu
  },
  { 
      title: "Investors", 
      submenus: [
  ...
  { 
      title: "Careers", 
      submenus: [
          "Rewards and benefits", "Career progression", "Graduates and students", 
          "Experienced professionals", "Diverse talent enables smarter steels", 
          "Frequently asked questions", "Search our jobs"
      ] 
  },
  { 
      title: "Media", 
      submenus: [
          "News articles", "Press releases", "Get in touch"
      ] 
  },
  { 
      title: "Smarter Future", 
      submenus: [
          "The Steel Works", "The Futurising Podcast"
      ] 
  }
];
  ...
  return (
    <header className={`header ${isHovered ? "scrolled" : ""}`}>
